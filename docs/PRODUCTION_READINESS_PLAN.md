...
managed backup/restore and rollback rehearsal from docs/STAGING_OPERATIONS_RUNBOOK.md
```
...
6. Execute provider operations and record results using [`STAGING_OPERATIONS_RUNBOOK.md`](STAGING_OPERATIONS_RUNBOOK.md) and [`STAGING_ACCEPTANCE_REPORT.md`](STAGING_ACCEPTANCE_REPORT.md); templates or local mocks are never remote evidence.
